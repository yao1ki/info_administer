...
const Login: React.FC<{}> = () => {
  ...
  const handleSubmit = async (values: LoginParamsType, forceLogin?: boolean) => {
    setSubmitting(true);
    try {
      // 登录
      const res = await login({ ...values, type, force: forceLogin });
      if (!res.error) {
        ...
        <div className={styles.top}>
          <div className={styles.header}>
            <Link to="/">
              ...
              <span className={styles.title}>地府管理系统</span>
            </Link>
          </div>
          <div className={styles.desc}>地府管理系统</div>
        </div>
